...
public class AddListActivity extends AppCompatActivity {
    ...
    String mDatabasePath = "Main_courses";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNameEt = (EditText)findViewById(R.id.listNameEt);
        mDescrEt = (EditText)findViewById(R.id.listDescrEt);
        mPostIv = (ImageView)findViewById(R.id.listImageTv);
        mUploadBtn = (Button)findViewById(R.id.listUploadBtn);
            ...
            storageReference2nd.putFile(mFilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>(){
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(AddListActivity.this,"Uploaded successfully...", Toast.LENGTH_SHORT).show();
