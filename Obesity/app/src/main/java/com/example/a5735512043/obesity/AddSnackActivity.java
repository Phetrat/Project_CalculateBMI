...
public class AddSnackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Add Snack");

        mNameEt = (EditText)findViewById(R.id.snackNameEt);
        mDescrEt = (EditText)findViewById(R.id.snackDescrEt);
        mPostIv = (ImageView)findViewById(R.id.snackImageTv);
        mUploadBtn = (Button)findViewById(R.id.snackUploadBtn);
        ...
        //progress dialog
        mProgressDialog = new ProgressDialog(AddSnackActivity.this);
    }
            ...
            storageReference2nd.putFile(mFilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>(){
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(AddSnackActivity.this,"Uploaded successfully...", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            mProgressDialog.dismiss();
                            //show error toast
                            Toast.makeText(AddSnackActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
